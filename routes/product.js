...
router.post('/products',validateProduct,isLoggedin, async(req,res)=>{
    ...
    await Product.create({name , img , price , desc}) //data create kar rha hu or yeh await or async isliye likhte hai kyuki yeh return karta hai promises or yeh work async se sath he karta hai
